        ...
        <div className="easybuysell-cont">
            <Form className="siteformui" autoComplete="off" noValidate>
                    ...
                    <FormGroup className="col">
                        <div className="formflexlabel">
                            ...
                            <div className="labelassets">
                                <p>Kullanılabilir: <span>49,950,000.00 {fiatCurrency}</span></p>
                    ...
                    <FormGroup className="col">
                        <div className="formflexlabel">
                            ...
                            <div className="labelprice">
                                <p>Fiyat: <TildeSmIcon className="tildesm" /> <span>66,238.89 {fiatCurrency}</span></p>
                            </div>
                        </div>
                        <InputGroup>
                            <InputGroupAddon addonType="prepend">
                ...
                <div className="easybuysell-form-btns">
                    <Button variant="success" className="w-50">{cryptoCurrency} AL</Button>
                </div>
            </Form>
